...
export default function CompoundCard({ compound }) {
  ...
  return (
    <article
      onClick={() => router.push(compoundURL)}
      className="group cursor-pointer rounded-2xl border border-[#dbe8f3] bg-white p-5 shadow-sm transition hover:-translate-y-1 hover:shadow-xl"
    >
