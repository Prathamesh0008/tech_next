        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
          <div className="max-w-4xl">
            ...
            <h1 className="text-5xl lg:text-6xl font-light leading-tight mb-6">
              {hero?.title || `Testosterone Therapy in ${countrySlug}`}
            </h1>
            
            {/* Hero Subtitle */}
            <p className="text-xl text-blue-100/90 leading-relaxed max-w-3xl">
              {hero?.subtitle || `Comprehensive guide to regulations, formulations, and clinical guidelines`}
            </p>
          </div>
        </div>
      </section>
                        ...
                        <div className="flex items-start gap-5 mb-6">
                          ...
                          <div>
                            ...
                            <p className="text-sm font-medium text-blue-600">
                              {tab?.administration || 'Prescription required'}
                            </p>
                          </div>
                        </div>
              ...
              <div className="relative p-12 lg:p-16">
                <div className="max-w-3xl">
                  ...
                  <h2 className="text-4xl lg:text-5xl font-light text-white mb-6 leading-tight">
                    {regulation.animatedTitle || 'Regulatory Guidelines'}
                  </h2>
