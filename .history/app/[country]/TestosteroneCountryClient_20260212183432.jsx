...
export default function TestosteroneCountryClient({ country, countrySlug }) {
  ...
  return (
    <main className="bg-white">
     ...
     <section className={`relative bg-gradient-to-br ${countryGradient} text-white`}>
...
<h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-light leading-tight mb-4 sm:mb-6">
  {hero.title ? (
    typeof hero.title === 'object' ? (
      ...
      <span className="inline-block text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold bg-gradient-to-r from-white to-white/90 bg-clip-text text-transparent leading-tight">
