  ...
  {hero.title ? (
    typeof hero.title === 'object' ? (
      <span className="flex flex-wrap items-baseline gap-x-2 gap-y-1">
        <span className="text-white/90 text-lg sm:text-xl md:text-2xl lg:text-3xl whitespace-nowrap">
          {hero.title.prefix}
        </span>
        <span className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold bg-gradient-to-r from-white to-white/90 bg-clip-text text-transparent leading-none py-1">
