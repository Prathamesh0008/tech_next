              ...
              {hero.title ? (
                typeof hero.title === 'object' ? (
                  <div className="flex flex-col items-start gap-1 sm:gap-2">
                    ...
                    <span className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xlpb-10 font-bold bg-gradient-to-r from-white to-white/90 bg-clip-text text-transparent py-1">
