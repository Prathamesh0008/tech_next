...
export default function TestosteroneCountryClient({ country, countrySlug }) {
  ...
  return (
    <main className="bg-white">
      {/* HERO - Clean, responsive, no image */}
      <section className={`relative bg-gradient-to-br ${countryGradient} text-white overflow-hidden`}>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-24 lg:py-28 xl:py-32">
          <div className="max-w-4xl mx-auto lg:mx-0">
            ...
            {/* Hero Title */}
            {/* Hero Title - Responsive font sizes with proper padding */}
{/* Hero Title - Responsive font sizes with proper spacing */}
<h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-light leading-tight pb-2 mb-4 sm:mb-6">
  {hero.title ? (
    typeof hero.title === 'object' ? (
      <div className="flex flex-col items-start gap-1">
        <span className="text-white/90 text-lg sm:text-xl md:text-2xl lg:text-3xl">
          {hero.title.prefix}
        </span>
       <span className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold bg-gradient-to-r from-white to-white/90 bg-clip-text text-transparent leading-tight pb-2">
