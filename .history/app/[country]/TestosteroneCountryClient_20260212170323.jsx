...
export default function TestosteroneCountryClient({ country, countrySlug }) {
  ...
  return (
    <main className="bg-white">
      {/* HERO - With country image on the right */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="max-w-2xl">
              ...
              <div className="flex items-center gap-2 text-sm text-white/80 mb-6">
                ...
                <span className="text-white/50">•</span>
                <span className="text-white font-medium bg-white/20 px-3 py-1 rounded-full backdrop-blur-sm border border-white/30">
                ...
                {hero.title ? (
                  typeof hero.title === 'object' ? (
                    <span className="flex flex-wrap items-baseline gap-2">
                      <span className="text-white/90">{hero.title.prefix}</span>
                      <span className="text-6xl lg:text-7xl font-bold bg-gradient-to-r from-white to-white/90 bg-clip-text text-transparent">
                        {hero.title.highlight}
                      </span>
                      <span className="text-white/90">{hero.title.suffix}</span>
                    </span>
                  ) : (
                    hero.title
                  )
              ...
              {/* Hero Subtitle */}
              <p className="text-xl lg:text-2xl text-white/90 leading-relaxed mb-6 font-light">
                {hero.subtitle}
              </p>
              ...
              {hero.animatedSubtitle && (
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-lg text-white/80 font-mono tracking-wide">
                    {hero.animatedSubtitle}
                  </p>
                </div>
              )}
              ...
              <div className="flex flex-wrap gap-4 mt-10">
                <button className="group px-6 py-3 bg-white text-slate-900 rounded-xl font-medium hover:shadow-2xl hover:shadow-white/20 transition-all duration-300 transform hover:-translate-y-0.5 flex items-center gap-2">
                  Explore Resources
                  <FaArrowRight className="group-hover:translate-x-1 transition-transform" />
                </button>
                <button className="group px-6 py-3 bg-white/10 backdrop-blur-sm border border-white/30 rounded-xl font-medium hover:bg-white/20 transition-all duration-300 transform hover:-translate-y-0.5 flex items-center gap-2">
                ...
                {countryImage && !imageError ? (
                  <div className="relative rounded-3xl overflow-hidden shadow-2xl transform hover:scale-[1.02] transition-transform duration-500">
                    ...
                    <div className="absolute bottom-6 left-6 z-20">
                      <span className="text-white text-2xl font-bold bg-black/30 backdrop-blur-sm px-4 py-2 rounded-xl border border-white/20">
                        {data.name || countrySlug}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm border border-white/20 p-8">
                    <div className="aspect-[6/5] relative">
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="text-center">
                          <FaGlobe className="text-8xl text-white/40 mx-auto mb-4" />
                          <h3 className="text-2xl font-light text-white/90">
                            {data.name || countrySlug}
                          </h3>
                          <div className="w-20 h-0.5 bg-white/30 mx-auto mt-4"></div>
                        </div>
                      </div>
                      {/* Decorative circles */}
      ...
      {/* MAIN CONTENT - (rest of your component remains exactly the same) */}
          ...
          {content?.introduction && (
            <section className="relative group">
              ...
              <div className="pl-4 lg:pl-8">
                ...
                <h2 className="text-4xl lg:text-5xl font-light text-slate-900 mb-5 leading-tight">
