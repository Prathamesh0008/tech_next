              ...
              {hero.title ? (
                typeof hero.title === 'object' ? (
                  <span className="flex flex-col sm:flex-row flex-wrap items-start sm:items-baseline gap-1 sm:gap-2">
                    ...
                    <span className="text-4xl sm:text-5xl mb-10 md:text-6xl lg:text-7xl xl:text-8xl font-bold bg-gradient-to-r from-white to-white/90 bg-clip-text text-transparent">
