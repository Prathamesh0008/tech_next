              ...
              {hero.title ? (
                typeof hero.title === 'object' ? (
                  <div className="flex flex-col items-start gap-1 sm:gap-2">
                    {/* Prefix - Normal text */}
                    <span className="text-white/0 text-lg sm:text-xl md:text-2xl lg:text-3xl leading-tight">
                      {hero.title.prefix}
                    </span>
                    
                    {/* Highlight - BIG BOLD text with NO CROPPING */}
                    <span className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold bg-gradient-to-r from-white to-white/90 bg-clip-text text-transparent leading-[1.1] py-1">
