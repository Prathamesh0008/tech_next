...
const HealthAccordBanner = () => {
  ...
  return (
    <section className="text-white relative overflow-hidden bg-[#18487d] sm:bg-transparent">
      ...
      <div className="relative p-2 sm:p-0 overflow-hidden isolate">
            ...
            <div className="relative z-10 grid grid-cols-4 md:grid-cols-4 gap-2.5 sm:gap-4">
            {globalImpactStats.map((s, i) => (
              <div key={i} className="relative z-10 bg-white/60 p-2.5 sm:p-3 rounded-lg text-center min-w-0">
                <div className=" min-[420px]:text-xl sm:text-xl font-bold text-black">{s.value}</div>
